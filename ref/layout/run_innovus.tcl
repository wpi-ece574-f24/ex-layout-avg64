...
# DRC and LVS
check_drc           -out_file reports/layout_check_drc.rpt
check_connectivity  -out_file reports/layout_check_connectivity.rpt
...
report_summary -no_html -out_file reports/layout_summary.rpt
